...
public class PuzzleGrid {
     ...
     */
    public static PuzzleGrid of(int[][] grid) {
        verifyGrid(grid);
     ...
     */
    public static PuzzleGrid emptyGrid() {
        int[][] emptyGrid = new int[9][9];
        return PuzzleGrid.of(emptyGrid);
    }
    ...
    private static class StringConverter {
        public static String toString(PuzzleGrid grid) {
        ...
        private static void printValue(StringBuilder builder, PuzzleGrid grid, int row, int column) {
